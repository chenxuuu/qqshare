 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'http://qqshare.papapoi.com/images/'; //图片路径配置
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" style="background-image: url(http://i13.tietuku.com/a620a0ff64fc3f4c.png) !important;background: url(http://i12.tietuku.com/4c7ac74d846daa89.gif) no-repeat 0 0;"><div style="width: 13px;"></div></td>\
      <td height="33" style="background-image:url(http://i13.tietuku.com/afe63bc3edef20e7.png) !important;background: url(http://i13.tietuku.com/d9798251010e0f71.gif) repeat-x top;"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><img align="absmiddle" src="http://i13.tietuku.com/8eb90f1ffcb9bc7f.gif"/><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(http://i13.tietuku.com/56be37b67d061984.gif)\'" onmouseover="this.style.backgroundImage=\'url(http://i13.tietuku.com/7d31ccfd69ef5de4.gif)\'" style="margin-top:5px; position: relative; cursor: pointer; float: right; height: 17px; width: 28px; background-image: url(http://i13.tietuku.com/56be37b67d061984.gif);' + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="13" height="33" style="background-image: url(http://i11.tietuku.com/1ad150a4391b994f.png) !important;background: url(http://i13.tietuku.com/1461ddf29264c94f.gif) no-repeat right 0;"><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" style="background-image: url(http://i11.tietuku.com/613758cb06102185.png) !important;background: url(http://i13.tietuku.com/e52cfddc10a04878.gif) repeat-y left;"></td>\
	...
	' + (function (obj) {
      ...
      <td width="13" style="background-image: url(http://i12.tietuku.com/58a43e9e8f71d912.png) !important;background: url(http://i13.tietuku.com/18dc5e9a5f411121.gif) repeat-y right;"></td>\
    </tr>\
    <tr>\
      <td width="13" height="13" style="background-image: url(http://i11.tietuku.com/31b322e9348b4e7a.png) !important;background: url(http://i13.tietuku.com/d85150c736becfd2.gif) no-repeat 0 bottom;"></td>\
      <td style="background-image: url(http://i13.tietuku.com/f101ad74adfbecd7.png) !important;background: url(http://i11.tietuku.com/d5cb8d32358c3be7.gif) repeat-x bottom;"></td>\
      <td width="13" height="13" style="background-image: url(http://i12.tietuku.com/0dc37b7c01a449c1.png) !important;background: url(http://i13.tietuku.com/c9c040d44b1b9b93.gif) no-repeat right bottom;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="http://i12.tietuku.com/c7f9fda5c1ff7404.gif" width="34" height="34" align="absmiddle"></td>\
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="http://i11.tietuku.com/dd4869494163a721.gif" width="34" height="34" align="absmiddle"></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:9pt">' + msg + '</td></tr>\
	</table>';
    diag.show();
    diag.okButton.parentNode.style.textAlign = "center";
